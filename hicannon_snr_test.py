...
pickling_on = open('cannon2_specmatch_spectra_snr' + str(target_snr) + '.pkl', "wb")
...
# --------------------------- pickles things --------------------------------------
# Cannon-derived flux
pickling_on = open('cannon2_cannon_spectra_snr' + str(target_snr) + '.pkl', "wb")
pickle.dump(cannon_spectra,pickling_on)

# Cannon-derived parameters
pickling_on = open('cannon2_cannon_labels_snr' + str(target_snr) + '.pkl', "wb")
pickle.dump(cannon_labels,pickling_on)

# Cannon model intrinsic variance
pickling_on = open('cannon2_s2_snr' + str(target_snr) + '.pkl', "wb")
